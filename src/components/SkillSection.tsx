...
const SkillSection: React.FC<SkillSectionProps> = ({ skillsData, theme }) => {
  ...
  return (
    <article
      className={`h-auto rounded-2xl p-10 pt-32 grid grid-cols-3 gap-7 relative z-10 max-lg:w-full max-lg:grid-cols-2 max-lg:p-8  max-lg:pt-32 ${
        theme === "dark"
          ? "bg-[--blackblue] dark-mode-shadow"
          : "bg-[--silentmooncolor] dark-shadow"
      }`}
    >
      <div

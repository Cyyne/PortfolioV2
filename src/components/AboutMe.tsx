  ...
  return (
    <React.Fragment>
      <section className="relative mt-16 about-me " id="about-me" ref={ref}>
        <div className="flex flex-col items-center justify-center w-1/2 gap-6 p-32 title-container max-lg:w-full max-lg:p-16 max-lg:items-start">
          <motion.div
        ...
        <div className="flex flex-row justify-center gap-6 items-center pl-30 pr-32 mb-16  max-lg:flex-col max-lg:p-16 min-[1921px]:px-[45rem] min-[1921px]:mb-48">
          <article className="pl-60 max-lg:p-0">
            <img
              src={me}
              alt={me}
              className="rounded-2xl  border-solid border-[0.4rem] border-[--lightblue] hover:border-orange"
            />
          </article>
          <Swiper
            spaceBetween={100}
          ...
          >
            {paragraphs.map((paragraph, index) => (
              ...
              >
                <div className="flex flex-row items-center justify-start gap-6 max-lg:flex-col max-lg:justify-center max-lg:text-center ">
                  ...
                  <div>
                    <h2 className="text-3xl">{paragraph.title}</h2>
                  </div>
                </div>
                <div className="flex flex-row gap-10 max-lg:flex-col">
                  <div className="flex flex-col items-center justify-between gap-4 -mt-10 -mb-10 max-lg:flex-row max-lg:m-0">
            ...
            <div
              className="absolute bottom-0 right-0 z-10 flex items-center justify-center w-24 h-24 text-4xl font-bold autoplay-progress text-orange max-lg:w-16 max-lg:h-16 max-lg:text-3xl "
              slot="container-end"
            >
